...
*
*/
const PostFull = ({ data, location, pageContext }) => {
        ...
        <>
            ...
            <Layout footer={true} bodyClass="is-article is-article-full" isPost={true}>
                <article className="post mb-10 pt-8 lg:pt-10 relative">
                    ...
                    { post.feature_image && <ArticleFeaturedImage article={post} figureClass="block mx-auto mt-12 w-full" divClass="mx-auto w-full h-full simply-zoom" zoomable={false} /> }
